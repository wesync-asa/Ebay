        ...
        <div class="content-fluid" style="overflow: auto">
            ...
            <div class="col-sm-4">
                ...
                <div class="row">
                    <div class="row" style="margin-left: 20px;">
                        ...
                        <div class="col-sm-6" align="right"><h5>1棟</h5></div>
                    </div>
                            ...
                            <tr>
                                <td>
                                    <table border="1" width="100%" >
                                        <tr>
                                            <td align="center" width="23.5%">コード</td>
                                            <td align="center" width="75.5%">ビル名</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div style="width:100%; height:150px; overflow:auto;">
                                        <table border="1" width="100%" >
                                            <tr>
                                                <td align="center" width="25%">1001</td>
                                                <td align="center" width="75%">Build_name1</td>
                                            </tr>
                                            <tr>
                                                <td align="center" width="25%">1002</td>
                                                <td align="center" width="75%">Build_name2</td>
                                            </tr>
                                            <tr>
                                                <td align="center" width="25%">1003</td>
                                                <td align="center" width="75%">Build_name3</td>
                                            </tr>
                                            <tr>
                                                <td align="center" width="25%">1004</td>
                                                <td align="center" width="75%">Build_name4</td>
                                            </tr>
                                            <tr>
                                                <td align="center" width="25%">1005</td>
                                                <td align="center" width="75%">Build_name5</td>
                                            </tr>
                                            <tr>
                                                <td align="center" width="25%">1006</td>
                                                <td align="center" width="75%">Build_name6</td>
                                            </tr>
                                            <tr>
                                                <td align="center" width="25%">1007</td>
                                                <td align="center" width="75%">Build_name7</td>
                                            </tr><tr>
                                                <td align="center" width="25%">1008</td>
                                                <td align="center" width="75%">Build_name8</td>
                                            </tr>
                                            <tr>
                                                <td align="center" width="25%">1009</td>
                                                <td align="center" width="75%">Build_name9</td>
                                            </tr>
                                        </table>
                                    </div>
                                </td>
                ...
                <div class="row">
                    <div class="row" style="margin-left: 20px;">
                        ...
                        <div class="col-sm-6" align="right"><h5>7件</h5></div>
                    </div>
                    <div class="row" style="margin-left: 10px;">
                                    ...
                                    <div style="width:100%;">
                                        <table border="1" width="100%" >
                                            <tr>
                                                ...
                                                <td align="center" width="20%">18.06</td>
                                                <td align="center" width="10%">済み</td>
                                                <td align="center" width="45%">先⾏</td>
                                            </tr>
                                            <tr>
            ...
            <div class="col-sm-8">
                ...
                <div class="row" style="background-color: #ECF0D9">
                    ...
                    <div class="row col-sm-9 col-sm-offset-0" style="background-color: #FF0000">
                        <div class="col-sm-3 col-sm-offset-0" style="background-color: #00DD00;"><input type="text" name="" class="col-sm-9"><label>階</label></div>
                        <div class="col-sm-2" style="background-color: #AA0000"><input type="text" name="" class="col-sm-9"></div>
                        <div class="col-sm-3" style="background-color: #DD8900"><input type="text" name="" class="col-sm-9"><label>坪</label></div>
                        <div class="col-sm-3" style="background-color: #FFEE00"><input type="text" name="" class="col-sm-10"><label>m2</label></div>
                    </div>
